...
class Menu extends CI_Controller 
{
		...
		public function menu_delete($id)
	{
			...
			$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"> Success Deleted </div>');
			redirect('menu');
...
$data['m'] = $this->db->get('user_menu')->result_array();
	...
	public function submenu_edit_run()
	{
